...
TEST_F(SurfaceTest, SurfaceBufferInfoTest)
{
    ...
    auto buffer = surface.get_surface_buffer(SurfaceBufferFormat::Rgb24Unsigned);
    ASSERT_TRUE(buffer.width == 24);
    ASSERT_TRUE(buffer.height == 16);
    ASSERT_TRUE(buffer.format == SurfaceBufferFormat::Rgb24Unsigned);
...
TEST_F(SurfaceTest, SurfaceBufferMipmapDataTest)
{
    ...
    // 1 level mipmap
    buffer = surface.get_surface_buffer(SurfaceBufferFormat::Rgb24Unsigned, 1);
    ...
    // 2 level mipmap
    buffer = surface.get_surface_buffer(SurfaceBufferFormat::Rgb24Unsigned, 2);
